...
select i.market, e.asin as entry, i.fulfillment, i.purchase_date, sum(i.quantity) as total_quantity
from amazon_order_item i,
     amazon_entry e
where i.market = e.market
  and i.seller_sku like concat('%', e.sku, '-%')
group by i.market, e.asin, i.fulfillment, i.purchase_date;
...
select i.market, e.asin as entry, i.fulfillment, i.create_date, sum(i.in_stock_quantity) as quantity
from amazon_inventory i,
     amazon_entry e
where i.market = e.market
  and i.seller_sku like concat('%', e.sku, '-%')
group by i.market, e.asin, i.fulfillment, i.create_date;
